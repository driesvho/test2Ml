...
sales_train$channel <- ifelse(sales_train$channel %in% c("CH//Online", "CH//amazon.com"), 1, 0)
...
sales_test$channel <- ifelse(sales_test$channel %in% c("CH//Online", "CH//amazon.com"), 1, 0)
table(sales_test$channel)
